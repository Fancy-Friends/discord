 ...
 */
/**
 * Every Discord node executor — the PHP twin of `DISCORD_RUNNABLE_KINDS` in
 * @particle-academy/discord-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `DiscordFlow::register($kinds, $executors)` — one call, no directory scan.
